...
setInterval(async function () {
    ...
    for (const server of servers) {
        await axios({
            ...
            client.sms.enviar(process.env.WELLINGTON_TELEPHONE, `Olá ${server.developer.name} O servidor ${server.name} está fora do ar!,`)
                .then(function (data) {
                    console.log(data)
                })
