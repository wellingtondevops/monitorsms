...
setInterval(async function () {
    ...
    for (const server of servers) {
        await axios({
            ...
            client.sms.enviar(process.env.WELLINGTON_TELEPHONE, `Olá Guilherme avise ao desenvolvedor ${server.developer.name}, que os servidor ${server.name} está fora do ar!,`)
                .then(function (data) {
                    console.log(data)
                })
